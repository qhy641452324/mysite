...
export default function (app: any, settings: any) {
   ...
   * @return {String} html
   */
  async function render(view: any, options: any) {
    ...
    ejs.resolveInclude = function (name: any, filename: any, isDir: any) {
  ...
  app.context.render = async function (view: any, _context: any) {
    const ctx = this;
    ...
    if (layout) {
      ...
      context.block = function (blockname: any, default_txt: any) {
